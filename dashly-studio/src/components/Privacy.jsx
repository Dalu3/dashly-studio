    ...
    return (
        <main className="privacy-container">
            ...
            <ul>
                ...
                <li>To send occasional updates or offers (if you opt-in).</li>
            </ul>

            <h2>4. Cookies and Consent</h2>
            <p>
                We use a small number of cookies and similar technologies to
                keep the website working, understand site usage, and support
                marketing when those tools are enabled.
            </p>
            <ul>
                <li>
                ...
                <li>
                    Analytics cookies are optional and only run if you choose
                    to allow them.
                </li>
                <li>
                    Marketing cookies are optional and only run if you choose to
                    allow them.
                </li>
                <li>
            ...
            <p>
                We may use third-party services like analytics tools or email
                delivery platforms. These providers have their own privacy
                policies.
            </p>
